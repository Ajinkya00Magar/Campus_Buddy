...
export default function Sidebar({ role }: { role: UserRole }) {
  ...
  return (
    <aside className="w-64 bg-[#1E3A8A] flex flex-col h-full shadow-xl shrink-0">
      {/* Brand */}
      ...
      <div className="px-3 py-3 border-t border-white/10">
        <Link href="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-blue-200 hover:bg-white/10 hover:text-white text-sm font-medium transition-all">
