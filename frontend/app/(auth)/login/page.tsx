    ...
    <div className="grid min-h-[100dvh] overflow-hidden bg-background text-foreground lg:grid-cols-[0.9fr_1.1fr]">
      ...
      <main className="flex min-h-[100dvh] items-center justify-center p-4 sm:p-8">
        ...
        >
          ...
          {/* TiltCard wraps the card — the glare & tilt track the mouse pointer
              exactly like the clubs/events cards. Glare overlay is pointer-events-none
              so all form inputs and buttons remain fully clickable.
              AnimatePresence inside handles the login ↔ signup content swap. */}
          <TiltCard max={5} lift={false} className="rounded-lg w-full">
