...
. Harden Storage Buckets:
_ Go to Storage -> Buckets.
_ Select avatars: Set "Maximum File Size" to 2MB and allowed MIME types to image/_.
_ Select channel-files: Set "Maximum File Size" to 20MB. 3. Apply the SQL:
